...
export default function FooterSection() {
  return (
    <section id='Creator'>
      <footer className="flex flex-col py-16 md:py-32 gap-10">
        {/* Creator Section */}
        <div className="mt-6 flex flex-col items-center space-y-2">
          ...
          <Typography variant='body2'>
            Crafted with ❤️ by <Typography variant="small" className="font-medium text-foreground">Emmanuel</Typography>
          </Typography>
          <Typography variant='body2' className="text-xs text-muted-foreground">
            Built using <span className="font-medium text-foreground">
              Next.js, TypeScript, Tailwind CSS, shadcn/ui, Supabase, and Drizzle ORM
            </span>
          </Typography>
        ...
        <div className="mx-auto max-w-5xl px-6 flex flex-col items-center text-center space-y-4">
          {/* Logo */}
          ...
          <Typography variant="small" className="text-muted-foreground text-sm">
            © {new Date().getFullYear()} Pacestory, All rights reserved
          </Typography>
        </div>
      </footer>
    </section>
